...
# Вибір необхідних колонок та видалення пропущених значень
...
# Дослідження кількості дерев у лісі
...
# Дослідження максимальної глибини дерев
...
# Дослідження мінімальної кількості зразків для розбиття вузла
...
# Дослідження мінімальної кількості зразків для кожного листкового вузла
